...
//importing routes
//initialization
var app = (0, _express["default"])(); // middlewars

app.use((0, _morgan["default"])('dev')); //muestra los datos o request que llegan

app.use((0, _express.json)()); //hace que entienda formatos json
//routes
